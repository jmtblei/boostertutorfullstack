const products = [
    ...
    },
    {
        ...
        description: "The thirty-sixth Magc: The Gathering expansion set and first set in the Ravnica block. A new story begins in the Ravnica Cycle. This is the first expansion set to introduce hybrid mana symbols. Contains 15 (of 306 possible) black-bordered cards",
        price: 28,
        countInStock: 1000,
    ...
    {
        name: "Guildpact",
        description: "The thirty-seventh Magc: The Gathering expansion set and second set in the Ravnica block. The storyline of the Ravnica Cycle continues. Contains 15 (of 165 possible) black-bordered cards.",
        price: 20,
        countInStock: 1000,
    ...
    {
        name: "Dissension",
        description: "The thirty-eighth Magc: The Gathering expansion set and third and final set in the Ravnica block. The storyline of the Ravnica Cycle comes to an end. Contains 15 (of 180 possible) black-bordered cards.",
        price: 20,
        countInStock: 1000,
    ...
    {
        name: "Coldsnap",
        description: "The thirty-ninth Magc: The Gathering expansion set and third and final set in the Ice Age block. The storyline of the Ice Age Cycle comes to an end. This set replaced the Homelands expansion (printed in 1995) as a member of the block. Contains 15 (of 155 possible) black-bordered cards.",
        price: 33,
        countInStock: 1000,
    ...
    //     price: ,
    //     countInStock: 1000,
    //     imageURL: "https://media.magic.wizards.com/images/featured/EN_xxx_SetLogo.png",
    //     logoURL: "https://media.magic.wizards.com/images/featured/EN_xxx_SetIcon.png",
    //     symbolURL: "",
    //     setType: "Core",
    //     releaseDate: "",
    //     block: "Core",
